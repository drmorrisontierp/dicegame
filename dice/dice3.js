...
function changeLevel(flag) {
    ...
    if (level) {
        setAttributes(baseOne, {
            d: "M9 57 L13 9 Q15 7 17 7 L61 7 Q65 7 65 12 L59 57 Z ",
            transform: "scale(1,2)",
            fill: "#5c5353",
        })
        setAttributes(baseTwo, {
            d: "M9 57 L9 101 Q9 105 13 105 L55 105 Q59 105 59 101 L59 57",
            transform: "scale(1,2)",
            fill: "#d44a20"
        })
        setAttributes(textOne, {
            transform: "rotate(4) translate(9, -1)",
        })
        setAttributes(textTwo, {
            transform: "",
        })
        setAttributes(shadowOne, {
            d: "M9 57 L13 9 Q15 7 17 7 L61 8 Q65 8 65 12 L59 57 Z ",
            transform: "scale(1,2)",
            fill: "url(#ToggleOne)",
        })
        ...
        setAttributes(baseOne, {
            d: "M9 56 L9 10 Q9 6 15 6 L55 6 Q59 6 59 10 L59 56 Z",
            transform: "scale(1,2)",
            fill: "#d44a20",
        })
        setAttributes(baseTwo, {
            d: "M9 56 L13 103 Q15 105 17 105  L61 105 Q65 105 65 102 L59 56 Z ",
            transform: "scale(1,2)",
            fill: "#8a7d7d"
        })
        setAttributes(textOne, {
